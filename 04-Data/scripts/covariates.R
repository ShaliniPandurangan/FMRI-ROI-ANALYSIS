...
load("Yfit_diagnosed.Rdata")
load("Xfit_diagnosed.Rdata")
load("Yfit_non_diagnosed.Rdata")
load("Xfit_non_diagnosed.Rdata")
load("Yfit.Rdata")
load("Xfit.Rdata")
...
BIC_NETWORK_DIAG_RESI <- sapply(model_results_diag_nw_bic, function(y){
    res <- y$RESI
    res
})
...
AIC_NETWORK_DIAG_RESI <- sapply(model_results_diag_nw_aic, function(y){
    res <- y$RESI
    res
})
...
BIC_NETWORK_NON_DIAG_RESI <- sapply(model_results_non_diag_nw_bic, function(y){
    res <- y$RESI
    res
})
...
AIC_NETWORK_NON_DIAG_NO_WEIGHTS_RESI <- sapply(model_results_non_diag_nw_aic, function(y){
    res <- y$RESI
    res
})
...
AIC_NETWORK_NON_DIAG_RESI <- sapply(model_results_non_diag_aic, function(y){
    res <- y$RESI
    res
})
...
BIC_NETWORK_NON_DIAG_RESI <- sapply(model_results_non_diag_bic, function(y){
    res <- y$RESI
    res
})
...
BIC_NETWORK_POPU_RESI <- sapply(model_results_BIC, function(y){
    res <- y$RESI
    res
})
...
BIC_NETWORK_POPU_WEIGHTS_RESI <- sapply(model_results_BIC_WW, function(y){
    res <- y$RESI
    res
})
...
AIC_NETWORK_POPU_RESI <- sapply(model_results_AIC, function(y){
    res <- y$RESI
    res
})
...
AIC_NETWORK_POPU_WEIGHTS_RESI <- sapply(model_results_AIC_WW, function(y){
    res <- y$RESI
    res
})
